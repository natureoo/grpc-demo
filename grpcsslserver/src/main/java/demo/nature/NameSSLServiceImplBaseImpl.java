...
public class NameSSLServiceImplBaseImpl extends NameServiceGrpc.NameServiceImplBase {

    //记录名称内容的map，实际项目中应该放置在数据库
    private Map<String,String> map = new HashMap<String,String>();

    private Logger logger = Logger.getLogger(NameSSLServiceImplBaseImpl.class.getName());

    //构造方法中加入一些条目
    public NameSSLServiceImplBaseImpl() {
